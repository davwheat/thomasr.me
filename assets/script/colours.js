...
if(localStorage.getItem('colours') !== "off") {
    ...
    document.getElementById('bw-button').innerHTML = '<i class="fas fa-fw fa-tint"></i> go colourful';
}
...
function enableColours() {
    ...
    document.getElementById('bw-button').innerHTML = '<i class="fas fa-fw fa-tint-slash"></i> go neutral';
    window.location.reload();
}